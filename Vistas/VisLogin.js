...
const App = (nav) => {
  ...
  const handleGoogleSigingIn= () => {
    const config= {
      ...
      scopes: ['https://chatbottutorias.firebaseapp.com/__/auth/handler', 'villalobos.salmeron.1982@gmail.com'],
      webClientId: '881123316443-lsp562iem843jeq310kdd2n980h3pr9v.apps.googleusercontent.com',
